...
const LANG_NAME_TO_CODE = {
  ...
  norwegian: 'no', bokmål: 'no', nynorsk: 'no',
  ukrainian: 'uk', urdu: 'ur', persian: 'fa', farsi: 'fa',
  bengali: 'bn', tamil: 'ta', telugu: 'te', marathi: 'mr',
  gujarati: 'gu', kannada: 'kn', malayalam: 'ml', punjabi: 'pa',
  sinhala: 'si', sinhalese: 'si', khmer: 'km', lao: 'lo',
  burmese: 'my', myanmar: 'my',
  georgian: 'ka', amharic: 'am', swahili: 'sw', afrikaans: 'af',
  albanian: 'sq', armenian: 'hy', azerbaijani: 'az', basque: 'eu',
  belarusian: 'be', bosnian: 'bs', catalan: 'ca', welsh: 'cy',
  gaelic: 'gd', 'scots gaelic': 'gd', irish: 'ga', galician: 'gl',
  icelandic: 'is', macedonian: 'mk', maltese: 'mt', mongolian: 'mn',
  nepali: 'ne', pashto: 'ps', serbian: 'sr', somali: 'so',
  sundanese: 'su', tajik: 'tg', tatar: 'tt', turkmen: 'tk',
